...
const UUID = process.env.UUID || '27c895c8-4dc5-445e-9074-57551d29b602'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'eded458wwe43.muchiapp.top';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYzgxMGIxNTEwMzRmYjc4NjlmOTZjZjA2NWFjN2YwY2QiLCJ0IjoiNjRmNmRjMDUtOTU3OC00Y2RmLWJjMTEtMzI5MTcyZWY3YjBiIiwicyI6Ik9UUXlZekZqWXpBdE5UZGpaQzAwTXpJd0xXRTJOemt0WlRJMU56UmxaR1ZpT1dNMSJ9
...
const NAME = process.env.NAME || 'mmcc7799mu';                        // 节点名称
